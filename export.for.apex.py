...
def run(
        ...
        include=('engine', 'onnx'),  # include formats
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights.apex.private.crony.1435244588.1127E7B7107206013DE38A10EDDEEEB3-v5-n-416-50000-3-0.1.2.pt', help='model.pt path(s)')
