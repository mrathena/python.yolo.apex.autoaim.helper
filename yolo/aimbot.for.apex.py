...
init = {
    ads: 1,  # 移动倍数, 调整方式: 将 horizontal 和 vertical 先设置为 1, 开启自瞄后, 不断瞄准目标旁边并按住 F 键, 当准星移动稳定且精准快速时, 就找到了合适的 ADS 值
    ...
    weights: 'model.for.apex.dummy.pt',  # 权重文件, model.for.apex.dummy.pt, model.for.apex.pt
